  ...
  renderContent = () => {
    return (
      <Space direction="vertical" fillWidth>
        <Card header="显示一行文字" style={style} headerStyle={cardHeaderStyle}>
          <Ellipsis
            line={1}
            style={{
        ...
        <Card header="显示两行文字" style={style} headerStyle={cardHeaderStyle}>
          <Ellipsis
            line={2}
            style={{
        ...
        <Card header="显示三行文字" style={style} headerStyle={cardHeaderStyle}>
          <Ellipsis
            line={3}
            style={{
