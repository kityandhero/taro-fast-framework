...
Taro.options.html.transformElement = function (el) {
  if (el.nodeName === 'text') {
...
var PrismCode = /*#__PURE__*/function (_ComponentBase) {
  _inherits(PrismCode, _ComponentBase);

  var _super = _createSuper(PrismCode);
  ...
  function PrismCode(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "doWorkAdjustDidMount", function () {
      _this.hightLight();
    });

    _defineProperty(_assertThisInitialized(_this), "doWorkWhenDidUpdate", function (preProps, preState, snapshot) {
      _this.hightLight();
    });

    _defineProperty(_assertThisInitialized(_this), "triggerClick", function () {
  ...
  _createClass(PrismCode, [{
    ...
    value: function hightLight() {
      ...
      return Prism$1.highlight(code, Prism$1.languages[language], language);
    }
  }, {
    key: "renderFurther",
    value: function renderFurther() {
      ...
      var html = "<pre class=\"".concat(!plugins ? '' : plugins.join(' '), " tfc-prism-code-box\"><code class=\"", "language-".concat(language), "\">").concat(this.hightLight(), "</code></pre>");
      return /*#__PURE__*/jsx(HtmlBox, {
        html: html,
...
PrismCode.defaultProps = _objectSpread2({}, defaultProps);
