...
import { showRuntimeError, redirectTo, stringIsNullOrWhiteSpace, showWarnMessage } from './utils/tools.js';
import { getToken } from './utils/globalStorageAssist.js';
import { defaultSettingsLayoutCustom } from './utils/defaultSettingsSpecial.js';
...
function _apiVirtualSuccessAccess() {
  _apiVirtualSuccessAccess = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(_ref3) {
...
function _apiVirtualFailAccess() {
  _apiVirtualFailAccess = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(_ref4) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return new Promise(function (resolve) {
              setTimeout(function () {
                resolve(apiVirtualFailData(remoteResponse));
              }, 300);
            }).then(function (data) {
              result = data;
            });
...
function _apiVirtualAccess() {
  _apiVirtualAccess = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(_ref5) {
    var dataBuild, result, _result3, code, messageText;

    return regenerator.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            dataBuild = _ref5.dataBuild;
            result = {};
            _context3.next = 4;
            return new Promise(function (resolve) {
...
export { _asyncToGenerator as _, apiVirtualFailData as a, apiVirtualSuccessData as b, apiVirtualSuccessAccess as c, apiVirtualFailAccess as d, apiVirtualAccess as e, empty as f, regenerator as g, transferToVirtualAccess as t };
