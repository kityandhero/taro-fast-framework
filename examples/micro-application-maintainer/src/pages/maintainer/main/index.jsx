...
export const classPrefix = `root-maintainer`;
...
@connect(({ maintainer, session, entrance, global, schedulingControl }) => ({
  maintainer,
  session,
  entrance,
  global,
...
class maintainer extends PageWrapper {
  // showCallTrack = true;
                    ...
                    >
                      ...
                      >
                        <ColorText
                          ...
                          text={signInSuccess ? friendlyName : `点击登录`}
                        />
                      </Col>
