...
import { buildLatestApproveItem, HeadNavigationBox } from '../../../../utils';

// eslint-disable-next-line no-undef
definePageConfig({
  navigationBarTitleText: '已结束的',
...
class PageListLatestApprove extends PageNeedSignInWrapper {
  ...
  buildHeadNavigation = () => {
    return <HeadNavigationBox title="已处理审批" />;
  };
...
export default PageListLatestApprove;
