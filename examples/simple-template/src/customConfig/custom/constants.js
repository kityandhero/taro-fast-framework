...
export const logoBlueImage = `${filePrefix}1834027210680438784.png`;
...
export const verifyPhoneImage = `${filePrefix}1834035561451622400.png`;
export const verifyPhoneShieldBlue = `${filePrefix}1834035653227188224.png`;
